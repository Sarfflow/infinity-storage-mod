package sarfflow.infstorage.inventory;
...
public interface InfInventory extends Inventory {
     ...
     * 从物品列表创建物品栏。
     */
    static InfInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * 根据指定的尺寸创建新的物品栏。
     */
    static InfInventory ofSize(int size) {
